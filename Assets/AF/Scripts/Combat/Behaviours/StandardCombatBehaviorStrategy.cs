...
namespace AF.Combat.Behaviors
{
    ...
    public sealed class StandardCombatBehaviorStrategy : PilotBehaviorStrategyBase
    {
            ...
            DetermineAction(ArmoredFrame activeUnit, CombatSimulatorService ctx)
        {
            ...
            if (meleeW != null)
            {
                bool inRange = minDist <= meleeW.MaxRange;
                bool canAtk  = inRange &&
            ...
            if (rangedW != null)
            {
                bool inRange = minDist <= rangedW.MaxRange + 0.001f;
                bool canAtk  = inRange &&
            ...
            if (activeUnit.HasEnoughAP(mvCost))
            {
                ...
                else
                {
                    ...
                    {
                        float optimal = rangedW.MaxRange * OPTIMAL_RANGE_FACTOR;
