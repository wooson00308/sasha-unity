 ...
 */
function registerCreateExcelTools(server) {
    console.error("[ExcelCreateTools] Registering CREATE Excel tools...");
    server.tool("create_new_entity", createNewEntitySchema, async (args) => {
        ...
        try {
            ...
            const newRowValues = new Array(headerValues.length).fill(null);
...
//# sourceMappingURL=excelCreateTools.js.map